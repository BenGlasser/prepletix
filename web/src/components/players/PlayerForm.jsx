...
export default function PlayerForm({ player, teamId, onClose }) {
  ...
  const savePlayerData = async (updatedData = formData) => {
    ...
    try {
      ...
      console.log('Saving player data:', JSON.stringify(cleanFirestoreData, null, 2));
      ...
      if (player || createdPlayerId) {
        ...
        // Create new player
        const docRef = await addDoc(collection(db, 'players'), cleanFirestoreData);
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white/50 dark:bg-gray-700/50 backdrop-blur-sm p-6 rounded-2xl border border-gray-200/50 dark:border-gray-600/50">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <Input
                    ...
                    onKeyDown={(e) => handleInputKeyDown(e, 'name', e.target.value)}
                    icon={UserIcon}
                  ...
                  <Input
                    ...
                    onKeyDown={(e) => handleInputKeyDown(e, 'jerseyNumber', e.target.value)}
                    icon={HashtagIcon}
                    placeholder="Jersey #"
                  />
                </div>
                <Input
                  ...
                  onKeyDown={(e) => handleInputKeyDown(e, 'photoUrl', e.target.value)}
                  icon={PhotoIcon}
                  placeholder="https://..."
                  className="mt-6"
                />
              ...
              <div className="bg-white/50 dark:bg-gray-700/50 backdrop-blur-sm p-6 rounded-2xl border border-gray-200/50 dark:border-gray-600/50">
                ...
                {formData.contacts.map((contact, index) => (
                  <div key={index} className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-200/50 dark:border-gray-600/50 rounded-xl p-6 mb-4">
                    <div className="flex justify-between items-center mb-6">
                      <Checkbox
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      <Input
                        ...
                        onBlur={(e) => handleContactBlur(index, 'name', e.target.value)}
                        onKeyDown={(e) => handleContactKeyDown(e, index, 'name', e.target.value)}
                        icon={UserIcon}
                      />
                      <Select
                      ...
                      <Input
                        ...
                        onBlur={(e) => handleContactBlur(index, 'phone', e.target.value)}
                        onKeyDown={(e) => handleContactKeyDown(e, index, 'phone', e.target.value)}
                        icon={PhoneIcon}
                      />
                      <Input
                        type="email"
                        ...
                        onBlur={(e) => handleContactBlur(index, 'email', e.target.value)}
                        onKeyDown={(e) => handleContactKeyDown(e, index, 'email', e.target.value)}
                        icon={EnvelopeIcon}
                      />
                    </div>
                  </div>
              ...
              <div className="bg-white/50 dark:bg-gray-700/50 backdrop-blur-sm p-6 rounded-2xl border border-gray-200/50 dark:border-gray-600/50">
                    ...
                    {(formData.medicalInfo.allergies || []).map((allergy, index) => (
                      <div key={index} className="flex space-x-3">
                        <Input
                          ...
                          onBlur={(e) => handleArrayBlur('allergies', index, e.target.value)}
                          onKeyDown={(e) => handleArrayKeyDown(e, 'allergies', index, e.target.value)}
                    ...
                    {(formData.medicalInfo.medications || []).map((medication, index) => (
                      <div key={index} className="flex space-x-3">
                        <Input
                          ...
                          onBlur={(e) => handleArrayBlur('medications', index, e.target.value)}
                          onKeyDown={(e) => handleArrayKeyDown(e, 'medications', index, e.target.value)}
                ...
                <Textarea
                  ...
                  onKeyDown={(e) => handleMedicalKeyDown(e, 'notes', e.target.value)}
                  rows={4}
