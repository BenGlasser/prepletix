      ...
      <div className="max-w-md w-full space-y-8">
        ...
        >
          ...
          <button
            ...
            disabled={processing}
            className="w-full flex justify-center items-center px-4 py-3 border border-gray-600/30 rounded-lg shadow-sm text-base font-medium text-white hover:bg-gray-700/80 focus:ring-2 focus:ring-primary-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          ...
          >
            ...
            {processing ? "Processing..." : "Sign in with Google"}
          </button>
