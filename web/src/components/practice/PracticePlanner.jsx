...
export default function PracticePlanner() {
  ...
  const loadPracticePlans = useCallback(async () => {
    ...
    try {
      ...
      const planList = snapshot.docs.map((doc) =>
        PracticePlan.fromFirestore(doc)
      );
  ...
  const loadSpecificPlan = useCallback(
    async (id) => {
      try {
  ...
  if (showForm) {
    return <PracticePlanForm plan={editingPlan} onClose={handleFormClose} />;
  }
        ...
        <div className="flex justify-center items-center h-64">
          <div className="text-center">
            ...
            <div className="text-sm text-gray-400">
              Please select or create a team to view practice plans.
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mt-1">
                Plan and organize your team practices
              </p>
            </div>
          ...
          <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-md rounded-2xl shadow-lg border border-gray-200/50 dark:border-gray-700/50 p-12">
            <div className="text-center">
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-8 max-w-md mx-auto">
                Get started by creating your first practice plan. Plan drills,
                set focus areas, and organize your training sessions.
              </p>
              <button
                onClick={handleAddPlan}
